...
\begin{lema}
Naj bo $R$ kolobar. Označimo $\overline{R} = R/J(R)$. Naj bosta $e_1 = e_1^2 \neq 0$ in $e_2  =  e_2^2 \neq 0 $ idempotenta v $R$. Potem velja, da sta $R$-podmodula $e_1 R$ in $e_2R$ modula $R$ izomorfna natanko tedaj, ko sta izomorfna $\overline{R}$ podmodula $e_1 \overline{R}$ in $e_2 \overline{R}$ modula $\overline{R}$. 
\end{lema}
