...
Če $\textrm{char}(R) \neq 2^k$, potem $\textrm{char}(F)\neq 2$ in posledično $x\neq -x$ za vsak $x\neq 0$. Sledi, da ima $T(F)$ eno kompononento $K_1$ za vozlišče 0 in $\frac{1}{2}(|F| - 1)$ komponent $K_2$ za ostale pare vozlišč $x$ in $-x$. Spet sledi, da $T(R)$ ni povezan. Pokazati moramo še, da $T(R)$ res vsebuje prave komponente.

Ker pa je $Z(R) = J(R)$ v primeru lokalnega kolobarja ideal, je zaprt za seštevanje. 


Pokazati moramo le še, da elementi iz $R$, ki so v $R/Z(R)$ v istem odseku, tvorijo kopijo grafa $K_{|Z(R)|}$. Naj bosta torej $x$ in $y$ dva elementa, ki sta iz odseka $z+Z(R)$.

KAKO TO FORMALNO SPISATI???
